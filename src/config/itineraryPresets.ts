...
export const ITINERARY_PRESETS: Record<string, ItineraryPreset> = {
  ...
  '동북아_5박_도쿄': {
    label: '동북아 5박 (도쿄 왕복) — 데이터 미확인',
    nights: 5,
    ports: [
      { port: '도쿄',      arrival_time: '',      departure_time: '',      summary: '도착' },
      { port: '도쿄',      arrival_time: '',      departure_time: '16:00', summary: '크루즈 승선' },
      { port: '해상',      arrival_time: '',      departure_time: '',      summary: '' },
      { port: '제주',      arrival_time: '12:30', departure_time: '21:00', summary: '' },
      { port: '가고시마',  arrival_time: '13:00', departure_time: '21:00', summary: '' },
      { port: '해상',      arrival_time: '',      departure_time: '',      summary: '' },
      { port: '도쿄',      arrival_time: '08:00', departure_time: '',      summary: '하선·귀국' },
    ],
  },
  ...
  // ── 두바이 ────────────────────────────────────────────────────────────────
  '두바이_7박': {
    label: '두바이 7박 — 데이터 미확인',
    nights: 7,
    ports: [
      { port: '두바이',    arrival_time: '',      departure_time: '',      summary: '도착' },
      { port: '두바이',    arrival_time: '',      departure_time: '13:00', summary: '크루즈 승선' },
      ...
      { port: '두바이',    arrival_time: '08:00', departure_time: '',      summary: '하선·귀국' },
    ],
  },
  ...
  '동부지중해_7박_베니스': {
    label: '동부지중해 7박 (베니스 왕복) — 데이터 미확인',
    nights: 7,
    ports: [
      { port: '베니스',      arrival_time: '',      departure_time: '',      summary: '도착' },
      { port: '베니스',      arrival_time: '',      departure_time: '17:00', summary: '크루즈 승선' },
      ...
      { port: '베니스',      arrival_time: '08:00', departure_time: '',      summary: '하선·귀국' },
    ],
  },
  '동부지중해_8박_이스탄불': {
  ...
  // ── 북유럽 ────────────────────────────────────────────────────────────────
  '북유럽_7박_로테르담': {
    label: '북유럽 7박 (로테르담 왕복) — 데이터 미확인',
    nights: 7,
    ports: [
      { port: '로테르담',  arrival_time: '',      departure_time: '',      summary: '도착' },
      { port: '로테르담',  arrival_time: '',      departure_time: '15:00', summary: '크루즈 승선' },
      { port: '해상',      arrival_time: '',      departure_time: '',      summary: '' },
      ...
      { port: '해상',      arrival_time: '',      departure_time: '',      summary: '' },
      { port: '로테르담',  arrival_time: '07:00', departure_time: '',      summary: '하선·귀국' },
    ],
  },
  ...
  '아라비아반도_7박': {
    ...
    ports: [
      ...
      { port: '두바이 (아랍에미리트)',       arrival_time: '',      departure_time: '',      summary: '' },
      { port: '두바이 (아랍에미리트)',       arrival_time: '',      departure_time: '13:00', summary: '출발' },
      ...
      { port: '두바이 (아랍에미리트)',       arrival_time: '07:00', departure_time: '',      summary: '귀항' },
    ],
  },
  '동북아_6박_홍콩': {
    label: '동북아 6박 (홍콩 왕복)',
    nights: 6,
    ports: [
      { port: '홍콩 (홍콩)',                 arrival_time: '12:00', departure_time: '',      summary: '' },
      { port: '홍콩 (홍콩)',                 arrival_time: '',      departure_time: '16:00', summary: '출발' },
      { port: '해상',                        arrival_time: '',      departure_time: '',      summary: '' },
      { port: '오키나와 (일본)',             arrival_time: '11:30', departure_time: '20:00', summary: '' },
      { port: '기륭 (대만)',                 arrival_time: '13:00', departure_time: '23:00', summary: '' },
      { port: '해상',                        arrival_time: '',      departure_time: '',      summary: '' },
      { port: '홍콩 (홍콩)',                 arrival_time: '06:30', departure_time: '13:10', summary: '귀항' },
    ],
  },
  '동북아_6박_도쿄': {
    label: '동북아 6박 (도쿄 왕복)',
    nights: 6,
    ports: [
      { port: '도쿄 (일본)',                 arrival_time: '10:50', departure_time: '',      summary: '' },
      { port: '도쿄 (일본)',                 arrival_time: '',      departure_time: '16:00', summary: '출발' },
      { port: '해상',                        arrival_time: '',      departure_time: '',      summary: '' },
      { port: '제주 (한국)',                 arrival_time: '12:30', departure_time: '21:00', summary: '' },
      { port: '가고시마 (일본)',             arrival_time: '13:00', departure_time: '21:00', summary: '' },
      { port: '해상',                        arrival_time: '',      departure_time: '',      summary: '' },
      { port: '도쿄 (일본)',                 arrival_time: '08:00', departure_time: '12:50', summary: '귀항' },
    ],
  },
  '북유럽_8박': {
    ...
    nights: 8,
    ports: [
      { port: '로테르담 (네덜란드)',         arrival_time: '',      departure_time: '',      summary: '' },
      { port: '로테르담 (네덜란드)',         arrival_time: '',      departure_time: '15:00', summary: '출발' },
      { port: '해상',                        arrival_time: '',      departure_time: '',      summary: '' },
      ...
      { port: '해상',                        arrival_time: '',      departure_time: '',      summary: '' },
      { port: '로테르담 (네덜란드)',         arrival_time: '07:00', departure_time: '',      summary: '귀항' },
    ],
  },
  '동부지중해_8박': {
    ...
    nights: 8,
    ports: [
      { port: '베니스 (이탈리아)',           arrival_time: '19:00', departure_time: '',      summary: '' },
      { port: '베니스 (이탈리아)',           arrival_time: '',      departure_time: '17:00', summary: '출발' },
      ...
      { port: '베니스 (이탈리아)',           arrival_time: '08:00', departure_time: '',      summary: '귀항' },
    ],
  },
}
