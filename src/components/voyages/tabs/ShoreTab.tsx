...
import { fetchAllItinerary, fetchVoyages, saveItineraryDay, deleteItineraryDay, restoreItineraryDay } from '@/lib/queries/voyages'
  ...
  const deleteMut = useMutation({
    ...
    onSuccess: (_r, _id, ctx) => {
      ...
      toast.success('삭제됐습니다', snap ? {
        action: {
          label: '되돌리기',
          onClick: () => restoreItineraryDay(snap)
            .then(() => { qc.invalidateQueries({ queryKey: ['all-itinerary'] }); toast.success('복원됐습니다') })
